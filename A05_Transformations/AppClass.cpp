...
#pragma region YOUR CODE GOES HERE
	...
	m_m4Sun = glm::translate(sunPos);

	//Calculate the position of the Earth
	m_m4Earth = glm::rotate(m_m4Sun, m_fEarthTimer, vector3(0.0f, 1.0f, 0.0f)) * (distanceEarth * rotateX * glm::rotate(IDENTITY_M4, m_fEarthTimer * 365, vector3(0.0f, 0.0f, 1.0f)));
	

	//Calculate the position of the Moon
	m_m4Moon = glm::rotate(m_m4Earth, m_fEarthTimer, vector3(0.0f, 0.0f, 1.0f)) * distanceMoon * rotateX * glm::rotate(IDENTITY_M4, m_fMoonTimer, vector3(0.0f, 0.0f, 1.0f));
#pragma endregion
